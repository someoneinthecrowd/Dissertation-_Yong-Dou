...
Using the linear Poisson-Boltzmann equation \autocite{Berg2014}, the zeta potential is related to the surface charge as $\sigma=\varepsilon(1+\kappa a)\zeta/a$, where $\kappa$ is the Debye screening length. 
